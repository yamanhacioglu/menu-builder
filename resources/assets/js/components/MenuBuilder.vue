    ...
    <div class="row">
      <div class="col-md-12">
        <div class="row">
          <div class="col-md-12">
            <div class="create-btn">
              <button
                  ...
                  data-toggle="modal"
                  data-target="#addMenuItemModal"><i class="material-icons">adds</i> Add Menu Item
              </button>
              <button
                  v-on:click="showSettingsForm"
                  class="btn btn-info edit-info"
                  data-toggle="modal"
                  data-target="#settingsModal"><i class="material-icons">settings_appl</i> Settings
              </button>
              <button
                  id="show_menu_design"
                  class="btn btn-info edit-info"
                  ...
                  :data-prefix="prefix"
                  data-toggle="modal"
                  data-target="#showMenuModel"><i class="material-icons">visibility</i> View Design
              </button>
            </div>
          ...
          <div class="col-md-12">
            <div class="use-menu">
              <p>To use a menu on your site just call <span class="menu-code"> menu('{{ menu.slug }}')</span> Or <span
                  class="menu-code"> @menu('{{ menu.slug }}')</span></p>
            </div>
          </div>
        </div>
...
export default {
  ...
  methods: {
    fetchMenuItems: function () {
      ...
      this.isDestroyAble = false; // Add this line to set isDestroyAble to false
      let self = this;
      ...
      axios({
        ...
        if (res.data.success == true) {
          ...
          self.isDestroyAble = true; // Add this line to set isDestroyAble to true
        }
      })
